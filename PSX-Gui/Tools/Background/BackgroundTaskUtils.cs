...
namespace PlayStation_Gui.Tools.Background
{
    public class BackgroundTaskUtils
    {
        public const string BackgroundTaskEntryPoint = "Pureisuteshon.BackgroundNotify.BackgroundNotifyStatus";
        public const string BackgroundTaskName = "BackgroundNotifyStatus";
        public const string ToastBackgroundTaskEntryPoint = "Pureisuteshon.BackgroundNotify.ToastNotificationBackgroundTask";
